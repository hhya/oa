	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="name" style="width: 218px"><?php echo ($vo["title"]); ?></td>
                ...
                <td class="status"><?php if($vo["isread"] == 0): ?><span style="color: red">未读</span><?php else: ?><span style="color: green">已读</span><?php endif; ?></td>
                <td class="operate">
