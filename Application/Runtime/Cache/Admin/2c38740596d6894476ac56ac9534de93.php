	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
					...
					<td class="file"><?php echo ($vol["filename"]); if($vol["hasfile"] == 1): ?><a href='/index.php/Admin/Doc/upload/id/<?php echo ($vol["id"]); ?>'>【下载】</a><?php endif; ?></td>
	                <td class="content"><?php echo ($vol["author"]); ?></td>
	                <td class="addtime"><?php echo (date('Y-m-d H:i:s', $vol["addtime"])); ?></td>
	                <td class="operate">
	                	<a href ='javascript:;' class='show' data-id='<?php echo ($vol["id"]); ?>' data-title='<?php echo ($vol["title"]); ?>'>查看</a>
