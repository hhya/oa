...
<div class="main">
	...
	<p class="short-input ue-clear">
    	<label>密码：</label>
        <input name="password" type="password" placeholder="密码" style="width: 260px; height: 23px; border: 1px solid #c5d6e0"/>
    </p>
    <p class="short-input ue-clear">
    	<label>姓名：</label>
    ...
    <div class="short-input select ue-clear">
        ...
        <select name="dept_id">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>"><?php echo (str_repeat('&emsp;',$vol["level"]*2)); echo ($vol["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>
	<p class="short-input ue-clear">
    	<label>性别：</label>
