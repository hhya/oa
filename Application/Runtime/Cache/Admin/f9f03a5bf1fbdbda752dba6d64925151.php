...
<div class="pagination ue-clear">
    ...
    <div class="pxofy">显示第 1 条到 2 条记录，总共<?php echo ($count); ?>条记录</div>
</div>
</body>
...
$(function(){
    ...
    $('.del').on('click', function() {
        var idObj = $(':checkbox:checked'); //获取选择框
        var id = ''; //声明空字符串id,组成id1,id2,id3...样式
        for (var i = 0; i < idObj.length; i++) {
            id += idObj[i].value + ',';
        }
        id = id.substring(0, id.length - 1); //去除尾部逗号
