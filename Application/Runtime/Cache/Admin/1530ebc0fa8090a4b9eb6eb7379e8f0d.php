...
<div class="main">
    ...
    <p class="short-input ue-clear">
    	<label >内容：</label><br />
	    <script name="content" id="editor" type="text/plain" style="width:800px;height:300px;margin-left:80px"><?php echo (htmlspecialchars_decode($data["content"])); ?>
	    </script>
