...
<body>
  <div id="container">
    <div id="hd">
      <div class="hd-wrap ue-clear">
        ...
        <div class="login-info ue-clear">
          ...
          <div class="login-msg ue-clear"> <a href="<?php echo U('Email/recBox');?>" class="msg-txt" target="iframe">消息</a> <a href="<?php echo U('Email/recBox');?>" class="msg-num" target="iframe">0</a> </div>
        </div>
    ...
    <div id="bd">
      ...
      <div class="content">
        <!-- <iframe src="/oa/index.php/Admin/Index/home.html" id="iframe" width="100%" height="100%" frameborder="0"></iframe> -->
